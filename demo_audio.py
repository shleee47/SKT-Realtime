    ...
    def test(self, test_loader,text,counter):
        ...
        with torch.no_grad():
            for b, batch in enumerate(self.test_loader):
                ...
                print('audio: {}'.format(self.class_list[best_prediction.item()]))
                #with open(os.path.join(self.save_file_path,'audio.txt'), 'w',encoding='utf8') as f:
